...
$FB->llena_texto("Tipo de Servicio:",27,279, $DB, "(SELECT `idtiposervicio`,`tip_nom` FROM `tiposervicio`)", "","$valortservicio", 4, 1);
if($rw[24]=='' or $rw[24]==NULL or $rw[24]==0){ $creditos=3; } else { $creditos=1; }
$FB->llena_texto("&iquest;Credito?:",28, 216, $DB, "3","habilitarcredito(this.value,24,\"llega_sub2\",\"total valor\",1,0)", "$creditos", 1, 0);	


echo "<tr><td colspan=2><div id='llega_sub2' >";
		if($creditos==1){
