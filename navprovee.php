...
echo "<div class='pull-left btn btn-default'><a href='preveedores.php'><div style='color:#000'>Volver </div></a></div>";
...
// }
		...
		$FB->titulo_azul1("Fecha de carga",1,0,5); 
...
// $sql="SELECT `carp_id`, `carp_nombre` FROM `carpetasdocumentos` ";
 $sql="SELECT `arc_id`, `arc_nombre`, `arc_fechacarga`, `arc_idusuario`,`arc_descrip` FROM `archivos_bermudas` WHERE arc_idusuario ='$param2' ";
...
while($rw1=mysqli_fetch_row($DB1->Consulta_ID))
{
	...
	echo "<td ><a  onclick='pop_dis21(\"".$rw1[1]."\",\"verdocumento\",0)';  style='cursor: pointer;' title='Confirmar' ><img src='images/documento.png' width='40' height='34'>".$rw1[1]."</a></td>";
