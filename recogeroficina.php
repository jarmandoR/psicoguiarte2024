...
function llena_datos(ex, nivel, ordby, asc)
{
	...
	if(ex==1){
		destino="detalle_recogeroficina.php?p1="+p1+"&p2="+p2+"&p6="+p6;
		location.href=destino;
	}
	else {
		destino="detalle_recogeroficina.php?param31="+p1+"&param32="+p2+"&param34="+p4+"&param35="+p5+"&param36="+p6+"&param37="+p7+"&pagina="+pagina+"&ordby="+ordby+"&asc="+asc;
