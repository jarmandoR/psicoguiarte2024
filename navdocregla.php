...
echo "<div class='pull-left btn btn-default'><a href='documentoregla.php'><div style='color:#000'>Volver </div></a></div>";
...
// }
		...
		$FB->titulo_azul1("Documento o enlace",1,0,0); 
...
if ($rw1[1] == "" and  $rw1[4] != "") {
  ...
  //       }
		...
		if($nivel_acceso==1 or $nivel_acceso==18 or $nivel_acceso==20){
			$DB->edites($id_p, "documentosreglamento", 1, $condecion);
