...
//	p7=document.getElementById('param37').value;
	...
	if(ex==1){
		...
		destino="detalle_reportealarmas.php?param35="+p1+"&param36="+p2+"&pagina="+pagina+"&ordby="+ordby+"&asc="+asc;
...
if($rcrear==1) { $FB->nuevoname("crearalarma", $condecion, "Crear Alarma"); }
$FB->titulo_azul1("Reporte de Alarmas por Sede",9,0,5);  
