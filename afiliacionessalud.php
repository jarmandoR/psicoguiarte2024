...
$FB->llena_texto("Preescolar (0 a 5 anos):", 1, 5, $DB, $tipoexamen, "", "sss", 1, 0);
$FB->llena_texto("Edad escolar (6 a 12 anos):", 2, 5, $DB, $tipoexamen, "", "sss", 1, 0);
$FB->llena_texto("Adolescente:", 3, 5, $DB, $tipoexamen, "", "sss", 1, 0);
$FB->llena_texto("Adultos Jovenes (19 a 30 anos):", 4, 5, $DB, $tipoexamen, "", "sss", 1, 0);
$FB->llena_texto("Disolucion:", 5, 5, $DB, $tipoexamen, "", "sss", 1, 0);
