...
$FB->llena_texto("# de GUIA:",16, 1, $DB, "", "", $rw[16],17, 0);
...
$FB->llena_texto("Peso KG:",26,123, $DB, "", "","" ,4,'min=1' );	
...
$FB->llena_texto("Tipo de Servicio:",34,279, $DB, "(SELECT `idtiposervicio`,`tip_nom` FROM `tiposervicio`)", "","$valortservicio", 4, 1);
$FB->llena_texto("Tipo Pago:", 28, 213, $DB, "3", "valorpagar(this.value,17,\"llega_sub2\",\"total valor\",1,$id_usuario)","@$rw[25]",1, 1);
