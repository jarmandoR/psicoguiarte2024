...
$sedesesion=$_SESSION['usu_idsede'];
 ...
 $fechaComoEntero = strtotime($fechaactual); //Para calcular los febreros, saber dias y meses como entero
...
echo'<th>Pecio hora</th>';
echo'<th>Dias laborados</th>';
echo'<th>Dias Sub Transporte</th>';
echo'<th>Salario</th>';

echo'<th>Recargo nocturno</th>';
echo'<th>Recargo Dom/Fes Diu</th>';
echo'<th>Recargo Dom/Fes Nocturno</th>';
echo'<th>Total Recargos</th>';
echo'<th>Horas Ex. Diurno</th>';
echo'<th>Horas Ex. Noct</th>';
echo'<th>Horas Ex. Diurno Dom/Fes</th>';
echo'<th>Horas Ex. Noct Dom/Fes</th>';
echo'<th>Total Ho. Hex</th>';
echo'<th>Total Sub Transporte</th>';
...
echo'<th>Total S/P</th>';
echo'<th>NETO A PAGAR QUINCENAL (CONSIGNAR)</th>';
echo'<th>BON. EXTRAL. MENSUAL. NO SALARIAL</th>';
echo'<th>TO. BON. EXTRAL. MENSUAL. NO SALARIAL</th>';
...
// function money_format($curr,$price) {
