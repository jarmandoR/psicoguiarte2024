...
echo "<div class='pull-left btn btn-default'><a href='documentosempre.php'><div style='color:#000'>Volver </div></a></div>";
...
// }
		...
		$FB->titulo_azul1("Descripcion",1,0,5); 
...
$sql="SELECT `empre_id`, `empre_nombre`, `empre_descripcion`, `empre_usuario` FROM `documentos_empre` WHERE empre_carpeta ='$param2' ";
...
if ($rw1[1]=="" and $rw1[4] != "") {
	...
	echo "<td >
		...
		echo "<td >
		<a  onclick='pop_dis21(\"".$rw1[1]."\",\"verdocumento\",\"cedula cara2.pdf\",0)';  style='cursor: pointer;' title='Confirmar' ><img src='images/documento.png' width='40' height='34'>".$rw1[1]."</a></td>";
	}
  ...
  //       }
		...
		if($nivel_acceso==1 or $nivel_acceso==18 or $nivel_acceso==20){
			$DB->edites($id_p, "documentosempre", 1, $condecion);
